...
os.environ['MY_PROJECT_NAME'] = "FRE7773ML2022_HW4_task_2_modified"
...
class LogisticRegressionFlow(FlowSpec):
    ...
    """
    solver_for_model = Parameter('solver_for_model',
                      help='solvers for logistic regression models: \ninput like following, using comma to separate: \'newton-cg,sag,saga,lbfgs\'\n DO NOT FORGET TO USE QUOTES AS THIS IS STRING TEXT INPUT!!!AND PLEASE DO NOT PUT SPACE AFTER COMMA!!!THANK YOU!!!',
                      default='newton-cg,sag,saga,lbfgs')
    ...
    def set_hyperparameters(self):
        ...
        self.params = self.solver_for_model.split(',')
        print(self.params)
    ...
    def train_model(self):
        ...
        with experiment.train():
            experiment.log_parameter("solver_", self.solver)
